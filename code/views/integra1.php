...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Integrantes Grupo - Construccion de Software</h1>
        </div>
        <div class="col-sm-6">
                ...
                <div class="row">
                  <div class="col-7">
                    ...
                    <ul class="ml-4 mb-0 fa-ul text-muted">
                      ...
                      <li class="small"><span class="fa-li"><i class="fas fa-lg fa-info"></i></span> Grupo C - Construccion de Software</li>
                    </ul>
                  </div>
            ...
            <div class="card bg-light d-flex flex-fill">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  ...
                  <div class="col-5 text-center">
                    <img src="/img/Yandri.jpeg" alt="user-avatar" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card bg-light d-flex flex-fill">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  ...
                  <div class="col-5 text-center">
                    <img src="/img/Steven.jpeg" alt="user-avatar" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card bg-light d-flex flex-fill">
              ...
              <div class="card-body pt-0">
                <div class="row">
                  ...
                  <div class="col-5 text-center">
                    <img src="/img/Dereck.jpeg" alt="user-avatar" class="img-circle img-fluid">
                  </div>
                </div>
              </div>
            </div>
          ...
          <table class="table table-sm table-bordered mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>Yandri Guevara, Anthony Delgado</td>
              ...
              <tr>
                <td>03/07/2025</td>
                <td>Documentación</td>
                <td>Steven Iñiga, Alan Mite, Derek Cagua</td>
